...
import DifficultyDropdown from "../ui/DifficultyDropdown";
import Modes from "../ui/Modes";
import ModesDropdown from "../ui/ModesDropdown";
import TextContent from "../ui/TextContent";
import RestartTest from "../ui/RestartTest";

const TypingInactive = () => {
  return (
    <PageLayout className="flex flex-col items-start lg:w-[1440px] lg:h-[1024px] lg:gap-16 lg:py-8 lg:px-28 md:w-[768px] md:h-[1024px] md:gap-10 md:px-8 md:pt-8 md:pb-10 w-[375px] h-[812px] px-4 pt-4 pb-8 gap-8">
      {/* Header content */}
      <Header />
